...
namespace HW17
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Метод1 запущен формирования массива");
        ...
        {
            Console.WriteLine("Метод2 запущен вычисления среднего арифметического");
            Random rnd = new Random();
            int[] array = new int[size];
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Запуск метода 1 и метода 2 в разных потоках");
            ...
            task2.Wait();
            task1.Wait();
            Console.WriteLine("Запуск метода 1 и метода 2 асинхронно");
